...
int bindgen_gui_gf_gui_create_common(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_common(param0, param1, param2, param3, param4, param5);
	if(!(ret >= 0)) return 0;
...
int bindgen_gui_gf_gui_create_button(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_button(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_entry(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_entry(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_frame(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_frame(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_progress(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_progress(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_range(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_range(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_scrollbar(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_scrollbar(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_tab(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_tab(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_text(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_text(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
...
int bindgen_gui_gf_gui_create_window(lua_State* s) {
	...
	ret = (gf_gui_id_t)gf_gui_create_window(param0, param1, param2, param3, param4);
	if(!(ret >= 0)) return 0;
	lret = lua_newuserdata(s, sizeof(*lret));
	luaL_getmetatable(s, "GoldFishGUIComponent");
	lua_setmetatable(s, -2);
