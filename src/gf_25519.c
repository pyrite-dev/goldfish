...
COMPACT_25519_DECL extern const gf_uint8_t f25519_zero[F25519_SIZE];
#endif
COMPACT_25519_DECL extern const gf_uint8_t f25519_one[F25519_SIZE];

/* Load a small constant */
static COMPACT_25519_DECL void f25519_load(gf_uint8_t* x, gf_uint32_t c);

/* Copy two points */
static COMPACT_25519_DECL void f25519_copy(gf_uint8_t* x, const gf_uint8_t* a) { memcpy(x, a, F25519_SIZE); }

/* Normalize a field point x < 2*p by subtracting p if necessary */
static COMPACT_25519_DECL void f25519_normalize(gf_uint8_t* x);
 ...
 */
static COMPACT_25519_DECL gf_uint8_t f25519_eq(const gf_uint8_t* x, const gf_uint8_t* y);
 ...
 * undefined behaviour.
 */
static COMPACT_25519_DECL void f25519_select(gf_uint8_t* dst, const gf_uint8_t* zero, const gf_uint8_t* one, gf_uint8_t condition);

/* Add/subtract two field points. The three pointers are not required to
 * be distinct.
 */
static COMPACT_25519_DECL void f25519_add(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b);
static COMPACT_25519_DECL void f25519_sub(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b);

/* Unary negation */
static COMPACT_25519_DECL void f25519_neg(gf_uint8_t* r, const gf_uint8_t* a);

/* Multiply two field points. The __distinct variant is used when r is
 * known to be in a different location to a and b.
 */
#ifdef FULL_C25519_CODE
static COMPACT_25519_DECL void f25519_mul(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b);
#endif
static COMPACT_25519_DECL void f25519_mul__distinct(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b);
 ...
 */
static COMPACT_25519_DECL void f25519_mul_c(gf_uint8_t* r, const gf_uint8_t* a, gf_uint32_t b);

/* Take the reciprocal of a field point. The __distinct variant is used
 * when r is known to be in a different location to x.
 */
#ifdef FULL_C25519_CODE
static COMPACT_25519_DECL void f25519_inv(gf_uint8_t* r, const gf_uint8_t* x);
#endif
static COMPACT_25519_DECL void f25519_inv__distinct(gf_uint8_t* r, const gf_uint8_t* x);
 ...
 */
static COMPACT_25519_DECL void f25519_sqrt(gf_uint8_t* r, const gf_uint8_t* x);
...
#ifdef FULL_C25519_CODE
/* Useful constants */
COMPACT_25519_DECL extern const gf_uint8_t fprime_zero[FPRIME_SIZE];
COMPACT_25519_DECL extern const gf_uint8_t fprime_one[FPRIME_SIZE];
#endif

#ifdef FULL_C25519_CODE
/* Load a small constant */
static COMPACT_25519_DECL void fprime_load(gf_uint8_t* x, gf_uint32_t c);
#endif

/* Load a large constant */
static COMPACT_25519_DECL void fprime_from_bytes(gf_uint8_t* n, const gf_uint8_t* x, size_t len, const gf_uint8_t* modulus);

/* Copy an element */
static COMPACT_25519_DECL void fprime_copy(gf_uint8_t* x, const gf_uint8_t* a) { memcpy(x, a, FPRIME_SIZE); }

#ifdef FULL_C25519_CODE
/* Normalize a field element */
static COMPACT_25519_DECL void fprime_normalize(gf_uint8_t* x, const gf_uint8_t* modulus);

/* Compare two field points in constant time. Return one if equal, zero
 * otherwise. This should be performed only on normalized values.
 */
static COMPACT_25519_DECL gf_uint8_t fprime_eq(const gf_uint8_t* x, const gf_uint8_t* y);
 ...
 * undefined behaviour.
 */
static COMPACT_25519_DECL void fprime_select(gf_uint8_t* dst, const gf_uint8_t* zero, const gf_uint8_t* one, gf_uint8_t condition);

/* Add one value to another. The two pointers must be distinct. */
static COMPACT_25519_DECL void fprime_add(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* modulus);
#ifdef FULL_C25519_CODE
static COMPACT_25519_DECL void fprime_sub(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* modulus);
#endif

/* Multiply two values to get a third. r must be distinct from a and b */
static COMPACT_25519_DECL void fprime_mul(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b, const gf_uint8_t* modulus);

#ifdef FULL_C25519_CODE
/* Compute multiplicative inverse. r must be distinct from a */
static COMPACT_25519_DECL void fprime_inv(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* modulus);
#endif
#endif
/* ******* END:   c25519/fprime.h ******** */
...
static COMPACT_25519_DECL void sha512_init(struct sha512_state* s) { memcpy(s, &sha512_initial_state, sizeof(*s)); }

/* Feed a full block in */
#define SHA512_BLOCK_SIZE 128

static COMPACT_25519_DECL void sha512_block(struct sha512_state* s, const gf_uint8_t* blk);
 ...
 */
static COMPACT_25519_DECL void sha512_final(struct sha512_state* s, const gf_uint8_t* blk, size_t total_size);

/* Fetch a slice of the hash result. */
#define SHA512_HASH_SIZE 64

static COMPACT_25519_DECL void sha512_get(const struct sha512_state* s, gf_uint8_t* hash, unsigned int offset, unsigned int len);
 ...
 */
static COMPACT_25519_DECL void c25519_prepare(gf_uint8_t* key) {
	key[0] &= 0xf8;
	key[31] &= 0x7f;
	key[31] |= 0x40;
}
...
COMPACT_25519_DECL extern const gf_uint8_t c25519_base_x[F25519_SIZE];
 ...
 */
static COMPACT_25519_DECL void c25519_smult(gf_uint8_t* result, const gf_uint8_t* q, const gf_uint8_t* e);
#endif
/* ******* END:   c25519/c25519.h ******** */
...
struct ed25519_pt {
	gf_uint8_t x[F25519_SIZE];
	gf_uint8_t y[F25519_SIZE];
	gf_uint8_t t[F25519_SIZE];
	gf_uint8_t z[F25519_SIZE];
};
...
static COMPACT_25519_DECL void ed25519_project(struct ed25519_pt* p, const gf_uint8_t* x, const gf_uint8_t* y);

static COMPACT_25519_DECL void ed25519_unproject(gf_uint8_t* x, gf_uint8_t* y, const struct ed25519_pt* p);
...
static COMPACT_25519_DECL void	     ed25519_pack(gf_uint8_t* c, const gf_uint8_t* x, const gf_uint8_t* y);
static COMPACT_25519_DECL gf_uint8_t ed25519_try_unpack(gf_uint8_t* x, gf_uint8_t* y, const gf_uint8_t* c);

/* Add, double and scalar multiply */
#define ED25519_EXPONENT_SIZE 32

/* Prepare an exponent by clamping appropriate bits */
static COMPACT_25519_DECL void ed25519_prepare(gf_uint8_t* e) {
	e[0] &= 0xf8;
	e[31] &= 0x7f;
	e[31] |= 0x40;
}
...
static COMPACT_25519_DECL void ed25519_copy(struct ed25519_pt* dst, const struct ed25519_pt* src) { memcpy(dst, src, sizeof(*dst)); }

static COMPACT_25519_DECL void ed25519_add(struct ed25519_pt* r, const struct ed25519_pt* a, const struct ed25519_pt* b);
static COMPACT_25519_DECL void ed25519_double(struct ed25519_pt* r, const struct ed25519_pt* a);
static COMPACT_25519_DECL void ed25519_smult(struct ed25519_pt* r, const struct ed25519_pt* a, const gf_uint8_t* e);
...
static COMPACT_25519_DECL void edsign_sec_to_pub(gf_uint8_t* pub, const gf_uint8_t* secret);

/* Produce a signature for a message. */
#define EDSIGN_SIGNATURE_SIZE 64

static COMPACT_25519_DECL void edsign_sign(gf_uint8_t* signature, const gf_uint8_t* pub, const gf_uint8_t* secret, const gf_uint8_t* message, size_t len);

/* Verify a message signature. Returns non-zero if ok. */
static COMPACT_25519_DECL gf_uint8_t edsign_verify(const gf_uint8_t* signature, const gf_uint8_t* pub, const gf_uint8_t* message, size_t len);
...
#ifdef FULL_C25519_CODE
COMPACT_25519_DECL const gf_uint8_t f25519_zero[F25519_SIZE] = {0};
#endif
COMPACT_25519_DECL const gf_uint8_t f25519_one[F25519_SIZE] = {1};
...
static COMPACT_25519_DECL void f25519_select(gf_uint8_t* dst, const gf_uint8_t* zero, const gf_uint8_t* one, gf_uint8_t condition) {
	const gf_uint8_t mask = -condition;
	int		 i;

	for(i = 0; i < F25519_SIZE; i++) dst[i] = zero[i] ^ (mask & (one[i] ^ zero[i]));
}
...
static COMPACT_25519_DECL void f25519_add(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b) {
	...
	for(i = 0; i < F25519_SIZE; i++) {
		c >>= 8;
		c += ((gf_uint16_t)a[i]) + ((gf_uint16_t)b[i]);
		r[i] = c;
	}
...
static COMPACT_25519_DECL void f25519_sub(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b) {
	...
	c = 218;
	for(i = 0; i + 1 < F25519_SIZE; i++) {
		c += 65280 + ((gf_uint32_t)a[i]) - ((gf_uint32_t)b[i]);
		r[i] = c;
		c >>= 8;
	}

	c += ((gf_uint32_t)a[31]) - ((gf_uint32_t)b[31]);
	r[31] = c & 127;
	c     = (c >> 7) * 19;
...
static COMPACT_25519_DECL void f25519_mul__distinct(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b) {
	...
	for(i = 0; i < F25519_SIZE; i++) {
		...
		c >>= 8;
		for(j = 0; j <= i; j++) c += ((gf_uint32_t)a[j]) * ((gf_uint32_t)b[i - j]);

		for(; j < F25519_SIZE; j++) c += ((gf_uint32_t)a[j]) * ((gf_uint32_t)b[i + F25519_SIZE - j]) * 38;
 ...
 * storage.
 */
static COMPACT_25519_DECL void exp2523(gf_uint8_t* r, const gf_uint8_t* x, gf_uint8_t* s) {
	int i;
...
static COMPACT_25519_DECL void f25519_sqrt(gf_uint8_t* r, const gf_uint8_t* a) {
	gf_uint8_t v[F25519_SIZE];
	gf_uint8_t i[F25519_SIZE];
	gf_uint8_t x[F25519_SIZE];
	gf_uint8_t y[F25519_SIZE];
...
#ifndef COMPACT_DISABLE_ED25519
#ifdef FULL_C25519_CODE
COMPACT_25519_DECL const gf_uint8_t fprime_zero[FPRIME_SIZE] = {0};
COMPACT_25519_DECL const gf_uint8_t fprime_one[FPRIME_SIZE]  = {1};
#endif

static COMPACT_25519_DECL void raw_add(gf_uint8_t* x, const gf_uint8_t* p) {
	gf_uint16_t c = 0;
	int	    i;

	for(i = 0; i < FPRIME_SIZE; i++) {
		c += ((gf_uint16_t)x[i]) + ((gf_uint16_t)p[i]);
		x[i] = c;
		c >>= 8;
	}
}

static COMPACT_25519_DECL void raw_try_sub(gf_uint8_t* x, const gf_uint8_t* p) {
	gf_uint8_t  minusp[FPRIME_SIZE];
	gf_uint16_t c = 0;
	int	    i;

	for(i = 0; i < FPRIME_SIZE; i++) {
		c	  = ((gf_uint16_t)x[i]) - ((gf_uint16_t)p[i]) - c;
		minusp[i] = c;
		c	  = (c >> 8) & 1;
	}
...
static COMPACT_25519_DECL int prime_msb(const gf_uint8_t* p) {
	int	   i;
	gf_uint8_t x;
...
static COMPACT_25519_DECL void shift_n_bits(gf_uint8_t* x, int n) {
	gf_uint16_t c = 0;
	int	    i;
...
static COMPACT_25519_DECL void fprime_load(gf_uint8_t* x, gf_uint32_t c) {
	...
	for(; i < FPRIME_SIZE; i++) x[i] = 0;
}
#endif

static COMPACT_25519_DECL int min_int(int a, int b) { return a < b ? a : b; }
...
static COMPACT_25519_DECL void fprime_from_bytes(gf_uint8_t* n, const gf_uint8_t* x, size_t len, const gf_uint8_t* modulus) {
	...
	for(i = 0; i < preload_bytes; i++) n[i] = x[len - preload_bytes + i];
	...
	for(i = rbits - 1; i >= 0; i--) {
		const gf_uint8_t bit = (x[i >> 3] >> (i & 7)) & 1;
...
static COMPACT_25519_DECL gf_uint8_t fprime_eq(const gf_uint8_t* x, const gf_uint8_t* y) {
	...
	for(i = 0; i < FPRIME_SIZE; i++) sum |= x[i] ^ y[i];
...
static COMPACT_25519_DECL void fprime_select(gf_uint8_t* dst, const gf_uint8_t* zero, const gf_uint8_t* one, gf_uint8_t condition) {
	...
	for(i = 0; i < FPRIME_SIZE; i++) dst[i] = zero[i] ^ (mask & (one[i] ^ zero[i]));
}
...
static COMPACT_25519_DECL void fprime_mul(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* b, const gf_uint8_t* modulus) {
	...
	for(i = prime_msb(modulus); i >= 0; i--) {
		const gf_uint8_t bit = (b[i >> 3] >> (i & 7)) & 1;
		gf_uint8_t	 plusa[FPRIME_SIZE];
...
static COMPACT_25519_DECL void fprime_inv(gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* modulus) {
	...
	for(i = prime_msb(modulus); i >= 0; i--) {
		gf_uint8_t r2[FPRIME_SIZE];

		fprime_mul(r2, r, r, modulus);

		if((pm2[i >> 3] >> (i & 7)) & 1) fprime_mul(r, r2, a, modulus);
		else
			fprime_copy(r, r2);
	}
}
...
static COMPACT_25519_DECL gf_uint64_t load64(const gf_uint8_t* x) {
	gf_uint64_t r;
...
static COMPACT_25519_DECL void store64(gf_uint8_t* x, gf_uint64_t v) {
	x += 7;
	*(x--) = v;
	v >>= 8;
	*(x--) = v;
...
static COMPACT_25519_DECL gf_uint64_t rot64(gf_uint64_t x, int bits) { return (x >> bits) | (x << (64 - bits)); }

static COMPACT_25519_DECL void sha512_block(struct sha512_state* s, const gf_uint8_t* blk) {
	gf_uint64_t w[16];
	gf_uint64_t a, b, c, d, e, f, g, h;
	int	    i;
	...
	for(i = 0; i < 80; i++) {
		...
		const gf_uint64_t wi   = w[i & 15];
		const gf_uint64_t wi15 = w[(i + 1) & 15];
		const gf_uint64_t wi2  = w[(i + 14) & 15];
		const gf_uint64_t wi7  = w[(i + 9) & 15];
		const gf_uint64_t s0   = rot64(wi15, 1) ^ rot64(wi15, 8) ^ (wi15 >> 7);
		const gf_uint64_t s1   = rot64(wi2, 19) ^ rot64(wi2, 61) ^ (wi2 >> 6);

		/* Round calculations */
		const gf_uint64_t S0	= rot64(a, 28) ^ rot64(a, 34) ^ rot64(a, 39);
		const gf_uint64_t S1	= rot64(e, 14) ^ rot64(e, 18) ^ rot64(e, 41);
		const gf_uint64_t ch	= (e & f) ^ ((~e) & g);
		const gf_uint64_t temp1 = h + S1 + ch + round_k[i] + wi;
		const gf_uint64_t maj	= (a & b) ^ (a & c) ^ (b & c);
		const gf_uint64_t temp2 = S0 + maj;
...
static COMPACT_25519_DECL void sha512_final(struct sha512_state* s, const gf_uint8_t* blk, size_t total_size) {
	gf_uint8_t   temp[SHA512_BLOCK_SIZE] = {0};
...
#ifndef COMPACT_DISABLE_X25519
COMPACT_25519_DECL const gf_uint8_t c25519_base_x[F25519_SIZE] = {9};

/* Double an X-coordinate */
static COMPACT_25519_DECL void xc_double(gf_uint8_t* x3, gf_uint8_t* z3, const gf_uint8_t* x1, const gf_uint8_t* z1) {
	 ...
	 */
	gf_uint8_t x1sq[F25519_SIZE];
	gf_uint8_t z1sq[F25519_SIZE];
	gf_uint8_t x1z1[F25519_SIZE];
	gf_uint8_t a[F25519_SIZE];
...
static COMPACT_25519_DECL void xc_diffadd(gf_uint8_t* x5, gf_uint8_t* z5, const gf_uint8_t* x1, const gf_uint8_t* z1, const gf_uint8_t* x2, const gf_uint8_t* z2, const gf_uint8_t* x3, const gf_uint8_t* z3) {
	 ...
	 */
	gf_uint8_t da[F25519_SIZE];
	gf_uint8_t cb[F25519_SIZE];
	gf_uint8_t a[F25519_SIZE];
	gf_uint8_t b[F25519_SIZE];
...
static COMPACT_25519_DECL void c25519_smult(gf_uint8_t* result, const gf_uint8_t* q, const gf_uint8_t* e) {
	/* Current point: P_m */
	gf_uint8_t xm[F25519_SIZE];
	gf_uint8_t zm[F25519_SIZE] = {1};

	/* Predecessor: P_(m-1) */
	gf_uint8_t xm1[F25519_SIZE] = {1};
	gf_uint8_t zm1[F25519_SIZE] = {0};
	...
	for(i = 253; i >= 0; i--) {
		...
		gf_uint8_t xms[F25519_SIZE];
		gf_uint8_t zms[F25519_SIZE];
 ...
 * t is x*y.
 */
COMPACT_25519_DECL const struct ed25519_pt ed25519_base = {{0x1a, 0xd5, 0x25, 0x8f, 0x60, 0x2d, 0x56, 0xc9, 0xb2, 0xa7, 0x25, 0x95, 0x60, 0xc7, 0x2c, 0x69, 0x5c, 0xdc, 0xd6, 0xfd, 0x31, 0xe2, 0xa4, 0xc0, 0xfe, 0x53, 0x6e, 0xcd, 0xd3, 0x36, 0x69, 0x21}, {0x58, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66}, .t = {0xa3, 0xdd, 0xb7, 0xa5, 0xb3, 0x8a, 0xde, 0x6d, 0xf5, 0x52, 0x51, 0x77, 0x80, 0x9f, 0xf0, 0x20, 0x7d, 0xe3, 0xab, 0x64, 0x8e, 0x4e, 0xea, 0x66, 0x65, 0x76, 0x8b, 0xd7, 0x0f, 0x5f, 0x87, 0x67}, {1, 0}};

COMPACT_25519_DECL const struct ed25519_pt ed25519_neutral = {.x = {0}, .y = {1, 0}, .t = {0}, .z = {1, 0}};
...
COMPACT_25519_DECL const gf_uint8_t ed25519_d[F25519_SIZE] = {0xa3, 0x78, 0x59, 0x13, 0xca, 0x4d, 0xeb, 0x75, 0xab, 0xd8, 0x41, 0x41, 0x4d, 0x0a, 0x70, 0x00, 0x98, 0xe8, 0x79, 0x77, 0x79, 0x40, 0xc7, 0x8c, 0x73, 0xfe, 0x6f, 0x2b, 0xee, 0x6c, 0x03, 0x52};
...
static COMPACT_25519_DECL gf_uint8_t ed25519_try_unpack(gf_uint8_t* x, gf_uint8_t* y, const gf_uint8_t* comp) {
	const int  parity = comp[31] >> 7;
	gf_uint8_t a[F25519_SIZE];
	gf_uint8_t b[F25519_SIZE];
	gf_uint8_t c[F25519_SIZE];
...
/* k = 2d */
COMPACT_25519_DECL const gf_uint8_t ed25519_k[F25519_SIZE] = {0x59, 0xf1, 0xb2, 0x26, 0x94, 0x9b, 0xd6, 0xeb, 0x56, 0xb1, 0x83, 0x82, 0x9a, 0x14, 0xe0, 0x00, 0x30, 0xd1, 0xf3, 0xee, 0xf2, 0x80, 0x8e, 0x19, 0xe7, 0xfc, 0xdf, 0x56, 0xdc, 0xd9, 0x06, 0x24};

static COMPACT_25519_DECL void ed25519_add(struct ed25519_pt* r, const struct ed25519_pt* p1, const struct ed25519_pt* p2) {
	...
	gf_uint8_t b[F25519_SIZE];
	gf_uint8_t c[F25519_SIZE];
	gf_uint8_t d[F25519_SIZE];
	gf_uint8_t e[F25519_SIZE];
	gf_uint8_t f[F25519_SIZE];
	gf_uint8_t g[F25519_SIZE];
	gf_uint8_t h[F25519_SIZE];
...
static COMPACT_25519_DECL void ed25519_smult(struct ed25519_pt* r_out, const struct ed25519_pt* p, const gf_uint8_t* e) {
	struct ed25519_pt r;
	int		  i;
	...
	for(i = 255; i >= 0; i--) {
		const gf_uint8_t  bit = (e[i >> 3] >> (i & 7)) & 1;
		struct ed25519_pt s;
...
COMPACT_25519_DECL const gf_uint8_t ed25519_order[FPRIME_SIZE] = {0xed, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6, 0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10};

static COMPACT_25519_DECL void expand_key(gf_uint8_t* expanded, const gf_uint8_t* secret) {
...
static COMPACT_25519_DECL gf_uint8_t upp(struct ed25519_pt* p, const gf_uint8_t* packed) {
	gf_uint8_t x[F25519_SIZE];
	gf_uint8_t y[F25519_SIZE];
	gf_uint8_t ok = ed25519_try_unpack(x, y, packed);

	ed25519_project(p, x, y);
	return ok;
}

static COMPACT_25519_DECL void pp(gf_uint8_t* packed, const struct ed25519_pt* p) {
	gf_uint8_t x[F25519_SIZE];
	gf_uint8_t y[F25519_SIZE];
...
static COMPACT_25519_DECL void sm_pack(gf_uint8_t* r, const gf_uint8_t* k) {
	struct ed25519_pt p;
...
static COMPACT_25519_DECL void edsign_sec_to_pub(gf_uint8_t* pub, const gf_uint8_t* secret) {
	gf_uint8_t expanded[EXPANDED_SIZE];

	expand_key(expanded, secret);
	sm_pack(pub, expanded);
}

static COMPACT_25519_DECL void hash_with_prefix(gf_uint8_t* out_fp, gf_uint8_t* init_block, unsigned int prefix_size, const gf_uint8_t* message, size_t len) {
	struct sha512_state s;
	...
	if(len < SHA512_BLOCK_SIZE && len + prefix_size < SHA512_BLOCK_SIZE) {
		...
		for(i = SHA512_BLOCK_SIZE - prefix_size; i + SHA512_BLOCK_SIZE <= len; i += SHA512_BLOCK_SIZE) sha512_block(&s, message + i);
...
static COMPACT_25519_DECL void generate_k(gf_uint8_t* k, const gf_uint8_t* kgen_key, const gf_uint8_t* message, size_t len) {
	gf_uint8_t block[SHA512_BLOCK_SIZE];

	memcpy(block, kgen_key, 32);
	hash_with_prefix(k, block, 32, message, len);
}

static COMPACT_25519_DECL void hash_message(gf_uint8_t* z, const gf_uint8_t* r, const gf_uint8_t* a, const gf_uint8_t* m, size_t len) {
	gf_uint8_t block[SHA512_BLOCK_SIZE];
...
static COMPACT_25519_DECL void edsign_sign(gf_uint8_t* signature, const gf_uint8_t* pub, const gf_uint8_t* secret, const gf_uint8_t* message, size_t len) {
	gf_uint8_t expanded[EXPANDED_SIZE];
	gf_uint8_t e[FPRIME_SIZE];
	gf_uint8_t s[FPRIME_SIZE];
	gf_uint8_t k[FPRIME_SIZE];
	gf_uint8_t z[FPRIME_SIZE];
...
static COMPACT_25519_DECL gf_uint8_t edsign_verify(const gf_uint8_t* signature, const gf_uint8_t* pub, const gf_uint8_t* message, size_t len) {
	struct ed25519_pt p;
	struct ed25519_pt q;
	gf_uint8_t	  lhs[F25519_SIZE];
	gf_uint8_t	  rhs[F25519_SIZE];
	gf_uint8_t	  z[FPRIME_SIZE];
	gf_uint8_t	  ok = 1;
...
COMPACT_25519_DECL void compact_x25519_keygen(gf_uint8_t private_key[X25519_KEY_SIZE], gf_uint8_t public_key[X25519_KEY_SIZE], gf_uint8_t random_seed[X25519_KEY_SIZE]) {
...
COMPACT_25519_DECL void compact_x25519_shared(gf_uint8_t shared_secret[X25519_SHARED_SIZE], const gf_uint8_t my_private_key[X25519_KEY_SIZE], const gf_uint8_t their_public_key[X25519_KEY_SIZE]) {
	...
	gf_uint8_t clamped_private_key[X25519_KEY_SIZE];
...
static COMPACT_25519_DECL gf_uint8_t* append(gf_uint8_t* dst, const void* source, size_t length) {
	memcpy(dst, source, length);
	return dst + length;
}

COMPACT_25519_DECL void compact_x25519_derive_encryption_key(gf_uint8_t* encryption_key, size_t key_size, const gf_uint8_t shared_secret[X25519_SHARED_SIZE], const gf_uint8_t public_key1[X25519_KEY_SIZE], const gf_uint8_t public_key2[X25519_KEY_SIZE]) {
	if(key_size > SHA512_HASH_SIZE) {
		key_size = SHA512_HASH_SIZE;
	}
	gf_uint8_t  key_data[X25519_SHARED_SIZE + 2 * X25519_KEY_SIZE];
	gf_uint8_t* p = key_data;
...
COMPACT_25519_DECL void compact_ed25519_keygen(gf_uint8_t private_key[ED25519_PRIVATE_KEY_SIZE], gf_uint8_t public_key[ED25519_PUBLIC_KEY_SIZE], gf_uint8_t random_seed[ED25519_SEED_SIZE]) {
...
COMPACT_25519_DECL void compact_ed25519_calc_public_key(gf_uint8_t public_key[ED25519_PUBLIC_KEY_SIZE], const gf_uint8_t private_key[ED25519_PRIVATE_KEY_SIZE]) { memcpy(public_key, private_key + __PUBLIC_KEY_OFFSET, ED25519_PUBLIC_KEY_SIZE); }

COMPACT_25519_DECL void compact_ed25519_sign(gf_uint8_t signature[ED25519_SIGNATURE_SIZE], const gf_uint8_t private_key[ED25519_PRIVATE_KEY_SIZE], const void* message, size_t msg_length) { edsign_sign(signature, private_key + __PUBLIC_KEY_OFFSET, private_key, message, msg_length); }

COMPACT_25519_DECL gf_bool_t compact_ed25519_verify(const gf_uint8_t signature[ED25519_SIGNATURE_SIZE], const gf_uint8_t public_key[ED25519_PUBLIC_KEY_SIZE], const void* message, size_t msg_length) { return edsign_verify(signature, public_key, message, msg_length) != 0; }
#endif
