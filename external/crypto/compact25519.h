...
/*
 ...
 output:
	 ...
	 interested parties
*/
COMPACT_25519_DECL void compact_ed25519_calc_public_key(gf_uint8_t public_key[ED25519_PUBLIC_KEY_SIZE], const gf_uint8_t private_key[ED25519_PRIVATE_KEY_SIZE]);
...
*/
COMPACT_25519_DECL void compact_ed25519_sign(gf_uint8_t signature[ED25519_SIGNATURE_SIZE], const gf_uint8_t private_key[ED25519_PRIVATE_KEY_SIZE], const void* message, size_t msg_length);
...
/*
 ...
 returns:
     true if verified
*/
COMPACT_25519_DECL gf_bool_t compact_ed25519_verify(const gf_uint8_t signature[ED25519_SIGNATURE_SIZE], const gf_uint8_t public_key[ED25519_PUBLIC_KEY_SIZE], const void* message, size_t msg_length);
#endif
