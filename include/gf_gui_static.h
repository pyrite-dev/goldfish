 ...
 * @warning This file is auto-generated using ./tool/gengui.sh at `Thu May 15 01:31:08 JST 2025`
 */
...
static void gf_gui_init_calls(void){
	...
	strcpy(gf_gui_calls[2].name, "progress");
	gf_gui_calls[2].call = gf_gui_create_progress;
	/***  End  progress ***/
	/*** Begin range ***/
	gf_gui_calls[3].name = malloc(512);
	strcpy(gf_gui_calls[3].name, "range");
	gf_gui_calls[3].call = gf_gui_create_range;
	/***  End  range ***/
	/*** Begin scrollbar ***/
	gf_gui_calls[4].name = malloc(512);
	strcpy(gf_gui_calls[4].name, "scrollbar");
	gf_gui_calls[4].call = gf_gui_create_scrollbar;
	/***  End  scrollbar ***/
	/*** Begin tab ***/
	gf_gui_calls[5].name = malloc(512);
	strcpy(gf_gui_calls[5].name, "tab");
	gf_gui_calls[5].call = gf_gui_create_tab;
	/***  End  tab ***/
	/*** Begin text ***/
	gf_gui_calls[6].name = malloc(512);
	strcpy(gf_gui_calls[6].name, "text");
	gf_gui_calls[6].call = gf_gui_create_text;
	/***  End  text ***/
	/*** Begin window ***/
	gf_gui_calls[7].name = malloc(512);
	strcpy(gf_gui_calls[7].name, "window");
	gf_gui_calls[7].call = gf_gui_create_window;
	/***  End  window ***/
}
/**
 * @~english
